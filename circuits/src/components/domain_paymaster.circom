...
// regex: [^@]+@[a-zA-Z0-9.-]+
template DomainPaymasterRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[15][i].in[1] <== 127;
		and[27][i] = AND();
		and[27][i].a <== lt[14][i].out;
		and[27][i].b <== lt[15][i].out;
		eq[37][i] = IsEqual();
		eq[37][i].in[0] <== in[i];
		eq[37][i].in[1] <== 255;
		and[28][i] = AND();
		...
		lt[17][i].in[1] <== 127;
		and[30][i] = AND();
		and[30][i].a <== lt[16][i].out;
		and[30][i].b <== lt[17][i].out;
		and[31][i] = AND();
		...
		lt[19][i].in[1] <== 90;
		and[33][i] = AND();
		and[33][i].a <== lt[18][i].out;
		and[33][i].b <== lt[19][i].out;
		...
		lt[21][i].in[1] <== 122;
		and[34][i] = AND();
		and[34][i].a <== lt[20][i].out;
		and[34][i].b <== lt[21][i].out;
		eq[39][i] = IsEqual();
		eq[39][i].in[0] <== in[i];
		eq[39][i].in[1] <== 45;
		eq[40][i] = IsEqual();
		...
		multi_or[13][i].in[2] <== eq[39][i].out;
		multi_or[13][i].in[3] <== eq[40][i].out;
		multi_or[13][i].in[4] <== eq[41][i].out;
		multi_or[13][i].in[5] <== eq[42][i].out;
		multi_or[13][i].in[6] <== eq[43][i].out;
		multi_or[13][i].in[7] <== eq[44][i].out;
		multi_or[13][i].in[8] <== eq[45][i].out;
		multi_or[13][i].in[9] <== eq[46][i].out;
		multi_or[13][i].in[10] <== eq[47][i].out;
		multi_or[13][i].in[11] <== eq[48][i].out;
		multi_or[13][i].in[12] <== eq[49][i].out;
		multi_or[13][i].in[13] <== eq[50][i].out;
	...
	// substrings calculated: [{(9, 10), (10, 10)}]
	signal is_substr0[msg_bytes][3];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		 // the 0-th substring transitions: [(9, 10), (10, 10)]
